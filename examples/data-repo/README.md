...
Change the seed URL, turn on Pages, press the button once, and the rest is automatic. If a run fails, [troubleshooting](../../docs/troubleshooting.md) lists the known failures and what to do about each.
