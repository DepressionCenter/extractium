...
The test suite passes: 1,400 Python tests as of 2026-09-11, plus 36 Node tests for the JavaScript client (`node --test clients/js`) and 24 for the local Node MCP server (`node --test examples/mcp/local-node`).
