...
| [pypdf](https://github.com/py-pdf/pypdf) (`pdf` extra, carried by the lock file) | Reads the text, bookmarks, and properties of a PDF file, inside a child process with a time limit. Pure Python, no compiled part. Checked on 2026-09-15: its published advisories are resource-exhaustion cases on malformed files, none code execution; the pin starts past every fixed version. | BSD-3-Clause |
