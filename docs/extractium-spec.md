...
sources:
  - type: web
    ...
    read_documents: false           # fetch and read linked Word, OpenDocument, RTF, and PDF files
  - type: web
  ...
  - type: local
    ...
    read_documents: false           # true adds **/*.docx, **/*.odt, **/*.rtf, **/*.pdf to the globs
  - type: github_api
    ...
    read_documents: false           # read Word, OpenDocument, RTF, and PDF files, one request each
