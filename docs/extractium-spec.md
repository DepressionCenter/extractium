...
- `delay_seconds` (default 0.5) paces requests; `max_pages` (default 10,000) is a safety ceiling on what one source reads, in the source's own unit: pages for a crawl, videos, deposits, files, or concept files for the other kinds.
